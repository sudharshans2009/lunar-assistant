        ...
        <table className='w-full text-sm text-left text-gray-500 dark:text-gray-400'>
          ...
          <tbody>
            {costMapping.map(({ model, cost }) => (
              <tr
                key={model}
                className='bg-whitedark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700'
              >
                <td className='px-4 py-2'>{model}</td>
                <td className='px-4 py-2'>{cost.toPrecision(3)}</td>
              </tr>
            ))}
            <tr className='bg-whitedark:bg-gray-800 dark:border-gray-700 font-bold'>
