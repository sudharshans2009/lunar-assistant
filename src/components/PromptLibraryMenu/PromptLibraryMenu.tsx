...
const PromptLibraryMenuPopUp = ({
  ...
  return (
    ...
    >
      <div className='p-6border-gray-200 dark:border-gray-600 w-[90vw] max-w-full text-sm text-gray-900 dark:text-gray-300'>
        ...
        <div className='flex flex-col p-2 max-w-full' ref={container}>
          <div className='flex font-boldborder-gray-500/50 mb-1 p-1'>
          ...
          {_prompts.map((prompt, index) => (
            <div
              key={prompt.id}
              className='flex items-centerborder-gray-500/50 mb-1 p-1'
            >
