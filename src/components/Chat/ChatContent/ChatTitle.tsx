...
const ChatTitle = React.memo(({ noStyles, open }: { noStyles: Boolean, open: Boolean }) => {
  ...
  return config ? (
    <>
      <div
        style={noStyles === true ? {height: '53px', opacity: '0', ...openStyle} : fixedStyles}
        className='flex gap-x-4 gap-y-1 flex-wrap w-full items-center justify-centerborder-black/10 bg-gray-50 p-3 dark:border-gray-900/50 dark:bg-gray-700 text-gray-600 dark:text-gray-300 cursor-pointer transition-all'
        onClick={() => {
          setIsModalOpen(true);
        }}
      >
        {noStyles === false && (<><div className='text-center p-1 rounded-md bg-gray-300/20 dark:bg-gray-900/10 hover:bg-gray-300/50 dark:hover:bg-gray-900/50'>
